...
class App {
    ...
    animate() {
        ...
        if (this.curItem) {
            this.ctx.fillStyle = `#ffffff`; //원의 스타일.
            this.ctx.strokeStyle = `#ffffff`; //줄의 스타일.

            this.ctx.beginPath();
            this.ctx.arc(this.mousePos.x, this.mousePos.y, 2/*반지름*/, 0, Math.PI * 2);
            this.ctx.fill();

            this.ctx.beginPath();
            this.ctx.arc(this.curItem.centerPos.x, this.curItem.centerPos.y, 2, 0, Math.PI * 2);
            this.ctx.fill();
